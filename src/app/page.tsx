    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-foreground">RENTENBLICK.de</span>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Link href="/register">
                <Button className="px-6 bg-primary hover:bg-primary-hover">Registrieren</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6">RENTENBLICK.de</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-200">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">Rentencheck-Rechner</h3>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-200">
              <CardContent className="p-8">
                <div className="w-12 h-12 bg-[color-mix(in_oklch,var(--success)_15%,var(--background))] rounded-lg flex items-center justify-center mb-6">
                  <FileText className="h-6 w-6 text-success" />
                </div>
                <h3 className="text-xl font-semibold text-foreground mb-3">PDF-Berichte</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-200">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">Mandantenverwaltung</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-200">
              <CardContent className="p-8">
                <div className="w-12 h-12 bg-[color-mix(in_oklch,var(--warning)_15%,var(--background))] rounded-lg flex items-center justify-center mb-6">
                  <TrendingUp className="h-6 w-6 text-[color-mix(in_oklch,var(--warning)_85%,var(--foreground))]" />
                </div>
                <h3 className="text-xl font-semibold text-foreground mb-3">Trend-Analysen</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-200">
              <CardContent className="p-8">
                <div className="w-12 h-12 bg-[color-mix(in_oklch,var(--destructive)_15%,var(--background))] rounded-lg flex items-center justify-center mb-6">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-200">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">Zeitersparnis</h3>
                <p className="text-muted-foreground">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="bg-primary border-0 shadow-2xl">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl text-[color-mix(in_oklch,var(--primary)_30%,var(--background))] mb-8 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/register">
                  <Button
                    size="lg"
                    variant="secondary"
                    className="px-8 py-4 text-lg bg-white text-primary hover:bg-[var(--surface-subtle)] shadow-lg"
                  >

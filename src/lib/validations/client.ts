...
export const createClientSchema = z.object({
  first_name: z
    ...
    .regex(/^[a-zA-ZäöüÄÖÜß\s-]+$/, 'Der Vorname darf nur Buchstaben, Leerzeichen und Bindestriche enthalten'),

  last_name: z
    .string()
    .min(2, 'Der Nachname muss mindestens 2 Zeichen lang sein')
    .max(50, 'Der Nachname darf maximal 50 Zeichen lang sein')
    .regex(/^[a-zA-ZäöüÄÖÜß\s-]+$/, 'Der Nachname darf nur Buchstaben, Leerzeichen und Bindestriche enthalten'),

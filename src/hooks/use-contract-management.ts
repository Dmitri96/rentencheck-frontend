...
export const useContractManagement = (
  ...
  const handleAddPayoutContract = useCallback(() => {
    ...
    try {
      ...
      toast.success(
        "Auszahlungsvertrag erfolgreich hinzugefügt - Vergessen Sie nicht, die Daten zu bestätigen!",
      );
    } catch (error) {
  ...
  const handleAddPensionContract = useCallback(() => {
    ...
    try {
      ...
      toast.success(
        "Rentenvertrag erfolgreich hinzugefügt - Vergessen Sie nicht, die Daten zu bestätigen!",
      );
    } catch (error) {
  ...
  const handleAddIncomeEntry = useCallback(() => {
    ...
    try {
      ...
      toast.success(
        "Zusätzliche Einkunft erfolgreich hinzugefügt - Vergessen Sie nicht, die Daten zu bestätigen!",
      );
    } catch (error) {
    ...
    try {
      ...
      switch (type) {
        case "payout": {
          ...
          setState((prev) => ({ ...prev, showPayoutForm: false }));
          toast.success(
            "Auszahlungsvertrag erfolgreich aktualisiert - Vergessen Sie nicht, die Daten zu bestätigen!",
          );
          break;
        }
        case "pension": {
          ...
          setState((prev) => ({ ...prev, showPensionForm: false }));
          toast.success(
            "Rentenvertrag erfolgreich aktualisiert - Vergessen Sie nicht, die Daten zu bestätigen!",
          );
          break;
        }
        case "income": {
          ...
          setState((prev) => ({ ...prev, showIncomeForm: false }));
          toast.success(
            "Zusätzliche Einkunft erfolgreich aktualisiert - Vergessen Sie nicht, die Daten zu bestätigen!",
          );
          break;
        }
        default:

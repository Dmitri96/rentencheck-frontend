    ...
    <div className="bg-gray-50 p-4 rounded-lg border space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="space-y-1">
                ...
                <Input
                    ...
                    onChange={(e) => setPensionForm({ ...pensionForm, pensionStartYear: parseInt(e.target.value) || new Date().getFullYear() })}
                    placeholder="2025"
                    className="h-9"
                    disabled={isConfirmed}
                />
            ...
            <div className="space-y-1">
                ...
                <Input
                    ...
                    onChange={(e) => setPensionForm({ ...pensionForm, guaranteedAmount: parseFloat(e.target.value) || 0 })}
                    placeholder="0"
                    className="h-9"
                    disabled={isConfirmed}
                />
            ...
            <div className="space-y-1">
                ...
                <Input
                    ...
                    onChange={(e) => setPensionForm({ ...pensionForm, projectedAmount: parseFloat(e.target.value) || 0 })}
                    placeholder="0"
                    className="h-9"
                    disabled={isConfirmed}
                />
        ...
        <div className="grid grid-cols-1 gap-3">
            <div className="space-y-1">
                ...
                <Input
                    ...
                    onChange={(e) => setPensionForm({ ...pensionForm, monthlyAmount: parseFloat(e.target.value) || 0 })}
                    placeholder="0"
                    className="h-9"
                    disabled={isConfirmed}
                />
        ...
        <div className="flex gap-2">
            <Button 
                ...
                disabled={!pensionForm.contract || !pensionForm.contractType || pensionForm.monthlyAmount <= 0 || isConfirmed}
 ...
 */
export function PensionContractsSection({ data, contractManagement, isConfirmed }: PensionContractsSectionProps) {
    const {
        state,
        pensionForm,
        setPensionForm,
                ...
                <div key={index} className="bg-white border rounded-lg p-3 flex items-center justify-between">
                    <div className="flex-1">
                        ...
                        <div className="text-blue-600 font-semibold">
                            {contract.monthlyAmount.toLocaleString('de-DE', { minimumFractionDigits: 2 })} € / Monat
                        </div>

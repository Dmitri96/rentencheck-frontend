            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                    ...
                    <Input
                        ...
                        onChange={(e) => updateData({ pensionWishCurrentValue: Number.parseFloat(e.target.value) || 0 })}
                        placeholder="0"
                        className="h-12 border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition-all duration-200"
                        disabled={isConfirmed}
                    />
                ...
                <div className="space-y-3">
                    ...
                    <Input
                        ...
                        onChange={(e) => updateData({ guaranteedAmount: Number.parseFloat(e.target.value) || 0 })}
                        placeholder="0"
                        className="h-12 border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition-all duration-200"
                        disabled={isConfirmed}
                    />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                    ...
                    <Input
                        ...
                        onChange={(e) => updateData({ provisionDuration: Number.parseInt(e.target.value) || 0 })}
                        placeholder="92"
                        className="h-12 border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition-all duration-200"
                        disabled={isConfirmed}
                    />
                ...
                <div className="space-y-3">
                    ...
                    <Input
                        ...
                        onChange={(e) => updateData({ assumedInflation: Number.parseFloat(e.target.value) || 0 })}
                        placeholder="0"
                        step="0.1"
                        className="h-12 border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition-all duration-200"
                        disabled={isConfirmed}

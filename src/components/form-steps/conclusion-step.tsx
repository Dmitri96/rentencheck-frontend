            ...
            {isConfirmed && (
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-green-800 font-medium">Abschluss bestätigt - Bereit für PDF-Generierung</span>
                    </div>
                </div>
            )}
                ...
                <div className="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-blue-800 leading-relaxed">
                            Alle Schritte wurden durchlaufen. Sie können nun das PDF generieren oder noch einmal einzelne Schritte
                            bearbeiten, indem Sie die entsprechenden Abschnitte entsperren.
                        </p>
                    </div>
                </div>
            </div>
